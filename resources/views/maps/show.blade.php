                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        @if(isset($result->representations))
                            ...
                            @foreach($result->representations as $representation)
                                <div class="swiper-slide">
                                    <img src="{{media_url($representation->media, 'large')}}" alt="{{$result->name.' '.$count}}" class="img-zoom-gallery" data-id="{{$count++}}" property="contentUrl">
                                </div>
                                @break
                            @endforeach
                        @endif
                        @foreach($gallery as $image)
                            <div class="swiper-slide">
                                <img src="{{$image['image']}}" alt="{{$result->name.' '.$count}}" class="img-zoom-gallery" data-id="{{$count++}}">
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="col-md-8">
                        <dl class="info-grid">
                            ...
                            @if(isset($result->places) && count($result->places))
                                ...
                                <dd>
                                    @foreach($result->places as $place)
                                        <a href="{{url('maps/?places[1]=' . $place->id)}}" property="contentLocation">
                                        {{$place->name}}</a>
                                    @endforeach
                                </dd>
                            @endif
                            ...
                            @if(isset($result->creator) && !empty($result->creator))
                                ...
                                <dd>
                                    <a href="{{url('maps/?entities[1]=' . $result->creator_id)}}">
                                        {{$result->creator}}</a>
                                </dd>
                            @endif
                            @if(isset($result->collections) && count($result->collections))
                                ...
                                <dd>
                                    @foreach($result->collections as $collection)
                                        <a href="{{url('collections/' . $collection->id.'/maps')}}">
                                            {{$collection->name}}</a>
                                    @endforeach
                                </dd>
                            @endif
                            @if(isset($result->collection_call_number) && !empty($result->collection_call_number))
                                <dt>@lang('translations.map_source')</dt>
                    ...
                    <div class="row">
                        ...
                        @foreach($related as $object)
                            ...
                            <article class="col-md-6 col-xl-3 post-itm">
                                <a href="{{url('maps/' . $object->id)}}" class="post-itm__link">
